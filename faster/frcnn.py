...
import pickle
import os
import faster.nets.frcnn as frcnn
from faster.nets.frcnn_training import get_new_img_size
from keras import backend as K
from keras.layers import Input
from keras.applications.imagenet_utils import preprocess_input
from PIL import Image,ImageFont, ImageDraw
from faster.utils.utils import BBoxUtility
from faster.utils.anchors import get_anchors
from faster.utils.config import Config
import copy
import math
class FRCNN(object):
    _defaults = {
        "model_path": 'faster/logs/weights.h5',
        "classes_path": 'faster/model_data/voc_classes.txt',
        "confidence": 0.6,
    }
